...
int proses(int index_tarif, int index_bpm){
    ...
    if(tanggal<=15){
        ...
        if(pemakaian>=0 && pemakaian<=10){
            output_tarif=tarif[index_tarif][0];
            biaya=pemakaian*tarif[index_tarif][0];
            total_bayar=Administrasi+BPM[index_bpm]+biaya+denda[0];
            output_denda=denda[0];
        }else if(pemakaian>10 && pemakaian<=20){
            output_tarif=tarif[index_tarif][1];
            biaya=pemakaian*tarif[index_tarif][1];
            total_bayar=Administrasi+BPM[index_bpm]+biaya+denda[1];
            output_denda=denda[1];
            ...
            output_tarif=tarif[index_tarif][2];
            biaya=pemakaian*tarif[index_tarif][2];
            total_bayar=Administrasi+BPM[index_bpm]+biaya+denda[2];
            output_denda=denda[2];
        }
    }
    ...
    printf("\n\tTarif yang Dikenakan     : %.2f/m^3", output_tarif);
    printf("\n\t----------------------------------------------");
    printf("\n\tRincian Biaya: ");
